% socat-master(SECTION) | User Commands
%
% "February 27 2025"
...
socat-master - program to do something

# SYNOPSIS

**socat-master** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**socat-master** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **socat-master** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**socat-master** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    socat-master. See **foo.conf**(5) for further details.
...
**socat-master** provides some return codes, that can be used in scripts:
...
grigoriy <grigoriy.yashin@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 grigoriy
